...
from nets.frcnn_training import (ProposalTargetCreator, classifier_cls_loss,
                                 ...
                                 rpn_cls_loss, rpn_smooth_l1,absolute_percentage_error)
    ...
    if True:
        ...
        if ngpus_per_node > 1:
            with strategy.scope():
                ...
                model_all.compile(
                    loss = {
                        ...
                        metrics={
                'dense_class_{}'.format(num_classes):[absolute_percentage_error]
                 }
                )
        else:
            model_rpn.compile(
            ...
            model_all.compile(
                ...
                # ... any other metrics you want to monitor during training }
                 )    
        #---------------------------------------#
        #   获得学习率下降的公式
        #---------------------------------------#
